...
#ifndef Saiko_ZSIOWALLET_H
#define Saiko_ZSIOWALLET_H
...
public:
    CzSIOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSIO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSIO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
