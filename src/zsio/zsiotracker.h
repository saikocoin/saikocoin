...
#ifndef Saiko_ZSIOTRACKER_H
#define Saiko_ZSIOTRACKER_H
...
public:
    CzSIOTracker(std::string strWalletFile);
    ~CzSIOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSIOWallet* zSIOWallet = NULL);
