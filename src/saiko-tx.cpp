...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Saiko Core saiko-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  saiko-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded saiko transaction") + "\n" +
                               "  saiko-tx [options] -create [commands]   " + _("Create hex-encoded saiko transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded saiko transaction
