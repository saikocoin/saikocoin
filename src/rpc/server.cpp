...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Saiko features */
        {"saiko", "listmasternodes", &listmasternodes, true, true, false},
        {"saiko", "getmasternodecount", &getmasternodecount, true, true, false},
        {"saiko", "masternodeconnect", &masternodeconnect, true, true, false},
        {"saiko", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"saiko", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"saiko", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"saiko", "masternodecurrent", &masternodecurrent, true, true, false},
        {"saiko", "masternodedebug", &masternodedebug, true, true, false},
        {"saiko", "startmasternode", &startmasternode, true, true, false},
        {"saiko", "createmasternodekey", &createmasternodekey, true, true, false},
        {"saiko", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"saiko", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"saiko", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"saiko", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"saiko", "getmasternodescores", &getmasternodescores, true, true, false},
        {"saiko", "preparebudget", &preparebudget, true, true, false},
        {"saiko", "submitbudget", &submitbudget, true, true, false},
        {"saiko", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"saiko", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"saiko", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"saiko", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"saiko", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"saiko", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"saiko", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"saiko", "checkbudgets", &checkbudgets, true, true, false},
        {"saiko", "mnsync", &mnsync, true, true, false},
        {"saiko", "spork", &spork, true, true, false},
        {"saiko", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsioseed", &getzsioseed, false, false, true},
        {"zerocoin", "setzsioseed", &setzsioseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsio", &searchdzsio, false, false, true},
        {"zerocoin", "dzsiostate", &dzsiostate, false, false, true},
...
{
    return "> saiko-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34633/\n";
}
