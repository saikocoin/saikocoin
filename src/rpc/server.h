...
extern UniValue DoZsioSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzsioseed(const UniValue& params, bool fHelp);
extern UniValue getzsioseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsio(const UniValue& params, bool fHelp);
extern UniValue dzsiostate(const UniValue& params, bool fHelp);
