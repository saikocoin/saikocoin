...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SIO);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSaikoAmount"))
        SoftSetArg("-anonymizesaikoamount", settings.value("nAnonymizeSaikoAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in saiko.cpp during shotdown to also remove the window positions
