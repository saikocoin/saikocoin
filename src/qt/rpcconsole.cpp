                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSIOPathCustom = GetArg("-zsiobackuppath", "");
    ...
    if(!strzSIOPathCustom.empty()) {
        ui->wallet_customzsiobackuppath->setText(QString::fromStdString(strzSIOPathCustom));
        ui->wallet_customzsiobackuppath_label->setVisible(true);
        ui->wallet_customzsiobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSIOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Saiko RPC console.") + "<br>" +
