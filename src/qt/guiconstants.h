...
/* Saiko GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Saiko"
#define QAPP_ORG_DOMAIN "saiko.org"
#define QAPP_APP_NAME_DEFAULT "Saiko-Qt"
#define QAPP_APP_NAME_TESTNET "Saiko-Qt-testnet"
