...
/** Utility functions used by the Saiko Qt UI.
 */
namespace GUIUtil
{
...
// Render Saiko addresses in monospace font
...
// Parse "saiko:" URI into recipient object, return true on successful parsing
