...
RESOURCES += src/qt/saiko.qrc src/qt/saiko_locale.qrc

TRANSLATIONS += src/qt/locale/saiko_bg.ts \
                src/qt/locale/saiko_de.ts \
                src/qt/locale/saiko_en.ts \
                src/qt/locale/saiko_es.ts \
                src/qt/locale/saiko_fi.ts \
                src/qt/locale/saiko_fr.ts \
                src/qt/locale/saiko_it.ts \
                src/qt/locale/saiko_ja.ts \
                src/qt/locale/saiko_pl.ts \
                src/qt/locale/saiko_pt.ts \
                src/qt/locale/saiko_ru.ts \
                src/qt/locale/saiko_sk.ts \
                src/qt/locale/saiko_sv.ts \
                src/qt/locale/saiko_vi.ts \
                src/qt/locale/saiko_zh_CN.ts \
                src/qt/locale/saiko_zh_TW.ts
