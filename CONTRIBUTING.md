Contributing to Saiko Core
============================

The Saiko Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/saiko-project/saiko/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Saiko Core project, and is not to be
confused with overall Saiko Network Protocol consensus changes.

Whether a pull request is merged into Saiko Core rests with the project merge
...
Patches that change Saiko consensus rules are considerably more involved than
...
Where a patchset proposes to change the Saiko consensus, it must have been
...
The project leader is the release manager for each Saiko Core release.
