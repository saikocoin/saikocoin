...
from fake_stake.base_test import Saiko_FakeStakeTest

class zSIOValidCoinSpendTest(Saiko_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSIOs..." % DENOM_TO_USE)
